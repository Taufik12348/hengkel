...
""")
username = str(input("\033[33m[Yofiel] \033[93mUsername:"))
password = str(input("\033[33m[Yofiel] \033[93mPassword:"))
if password == "fiel" and username == "fiel":
    print ("Logged in as yofiel")
    time.sleep(2)
...
\033[93m            ║ XXXX       ║║ OVHDOS   ║║ DDOS-GUARD ║║ XXXXXX     ║
...
\033[0;96m                              
\033[0;96m =============YOFIEL CREATED THIS DDOS======================"""
...
def main():
    ...
    while True:
        ...
        sys.stdout.write("\x1b]2;[-]Yofiel | Online User : [{}] | Running Attack [6] | Bot Connected [89] | Admin : [Yofiel] | Backup Server : [2] | Username : admin\x07".format (powerran))
        sin = input("\033[95m[\033[97mYofiel\033[95m]\033[37m >> \033[92m".format(nicknm)).lower()
        sinput = sin.split(" ")[0]
